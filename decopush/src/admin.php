...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  renderAdminShell();
  await reloadData();
  // Solicitar permiso global de notificaciones (si el usuario no lo ha decidido todavía)
  if (typeof Notification !== 'undefined' && Notification.permission === 'default') {
    try { await Notification.requestPermission(); } catch(e) { /* ignore */ }
  }
  // Start global watcher for chat notifications
  try { TicketChat.startGlobalChatWatcher(); } catch(e) { /* ignore */ }
});
...
const TicketChat = (() => {
  ...
  return { open, close, _send, requestNotifPermission, startGlobalChatWatcher };
})();
</script>
</body>
</html>